  ...
  return (
    <div className=' p-7 flex flex-col justify-between h-screen '>
      <div>
        ...
        <p className='text-center text-sm text-gray-600 mt-4 '>Don't have an account? <Link to="/userSignup" className='text-blue-500'>Sign Up</Link></p>
      </div>
      <div>
        <Link to='/CaptainLogin' className=' flex justify-center bg-[#009E60] text-black px-2 py-2 mt-4 rounded  w-full text-xl font-semibold'> sign as captain </Link>
